...
module.exports = {
    ...
    testCSVParseGetColumnNames: function(test) {
        test.expect(2);
    ...
    testCSVParseEscapedComma: function(test) {
        test.expect(3);
    ...
    testCSVParseQuotes: function(test) {
        test.expect(2);
    ...
    testCSVParseEmbeddedQuotes: function(test) {
        test.expect(2);
    ...
    testCSVParseEmbeddedCommasInQuotes: function(test) {
        test.expect(2);
    ...
    testCSVParseTrimWhitespace: function(test) {
        test.expect(4);
    ...
    testCSVParseSkipEmptyLinesRightNumber: function(test) {
        test.expect(2);
    ...
    testCSVParseSkipEmptyLines: function(test) {
        test.expect(3);
    ...
    testCSVParseEmptyValues: function(test) {
        test.expect(4);
    ...
    testCSVParseMissingValues: function(test) {
        test.expect(6);
    ...
    testCSVParseWithTabSeparator: function(test) {
        test.expect(4);
    ...
    testCSVParseMissingValuesWithTabs: function(test) {
        test.expect(6);
    ...
    testCSVParseEscapedTab: function(test) {
        test.expect(4);
    ...
    testCSVParseQuotedValuesTabSeparator: function(test) {
        test.expect(4);
    ...
    testCSVParseWithTabSeparatorQuotedTabs: function(test) {
        test.expect(4);
    ...
    testCSVParseDOSFile: function(test) {
        test.expect(4);
