...
module.exports = {
    ...
    testIosStringsMakePathNameTarget: function(test) {
        test.expect(2);
        ...
        test.equal(strings.makePathName(), "testfiles/de.lproj/Localizable.strings");
        
        test.done();
    },

    testIosStringsMakePathNameSource: function(test) {
        test.expect(2);
        ...
        test.equal(strings.makePathName(), "testfiles/en-US.lproj/Localizable.strings");
        
        test.done();
    },
    
    testIosStringsMakePathNameAlreadyThere: function(test) {
        test.expect(2);
        ...
        test.equal(strings.makePathName(), "./objc/de.lproj/asdf.strings");
        
        test.done();
    },
    
    testIosStringsMakePathNameNoLocale: function(test) {
        test.expect(2);
    ...
    testIosStringsMakePathNameUnknownLocale: function(test) {
        test.expect(2);
        ...
        test.equal(strings.makePathName(), "testfiles/ps.lproj/Localizable.strings");
