...
AndroidResourceFileType.prototype.write = function(translations, locales) {
	...
	for (var i = 0; i < resources.length; i++) {
		...
		locales.forEach(function(locale) {
			...
			db.getResourceByHashKey(res.hashKey(), function(err, translated) {
...
AndroidResourceFileType.prototype.registerDataTypes = function() {
	ResourceFactory.registerDataType("x-android-resource", "resource-string", AndroidResourceString);
	ResourceFactory.registerDataType("x-android-resource", "resource-plural", ResourcePlural);
	ResourceFactory.registerDataType("x-android-resource", "resource-array", ResourceArray);
};
