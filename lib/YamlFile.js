    ...
    for (var key in obj) {
        if (typeof(obj[key]) === "object") {
            ...
            if (this._isTranslatable(resource)) {
                ...
                var sourceHash = utils.hashKey(obj[key]);
                var hashkey = ContextResourceString.hashKey(this.project.getProjectId(), prefix, sourceHash, locale, key, this.type.datatype);
                ...
                if (locale === this.project.pseudoLocale && this.project.settings.nopseudo) {
                    ...
                    if (sourceLocale !== this.project.sourceLocale) {
                        ...
                        var sourceHash = utils.hashKey(obj[key]);
                        var sourceRes = translations.get(ContextResourceString.hashKey(this.project.getProjectId(), prefix, sourcehash, sourceLocale, key, this.type.datatype));
