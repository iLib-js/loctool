...
var reUnicodeChar = /\\u([a-fA-F0-9]+)/g;
var reOctalChar = /\\([0-8]+)/g;

/**
 * Clean the string to make the source string. This means
 * removing leading and trailing white space, compressing
 * spaces, and unescaping special and Unicode characters.
 * 
 * @static
