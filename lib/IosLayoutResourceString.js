...
IosLayoutResourceString.prototype.hashKey = function() {
	return IosLayoutResourceString.hashKey(this.project, this.locale, this.pathName, this.reskey, this.flavor);
};
 ...
 */
IosLayoutResourceString.prototype.getFlavor = function() {
	return this.flavor;
};
