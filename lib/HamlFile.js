	...
	if (this.segments) {
		for (var i = 0; i < locales.length; i++) {
			...
			if (localized) {
				...
				fs.writeFileSync(pathName, localized, "utf-8");
			} else {
				logger.info("Skipping because it is not different than US English.");
			}
		}
	} else {
