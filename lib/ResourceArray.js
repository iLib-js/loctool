...
ResourceArray.prototype.getTarget = function(i) {
	return (i >= 0 && i < this.targetArray.length) ? this.targetArray[i] : undefined;
};
...
ResourceArray.prototype.addTarget = function(i, str) {
	...
	if (typeof(i) === "undefined" || i < 0 || typeof(str) === "undefined" || i > this.sourceArray.length) {
		return;
	}
...
ResourceArray.prototype.size = function() {
	return this.sourceArray ? this.sourceArray.length : 0;
};
