...
/**
 * Return the unique id of this resource array.
 * 
...
/**
 * Return a new resource array where the id is the same as the current
 ...
 * the same unique id as the current object, and the translations
 * to the given locale
 */
 ...
 * resource array has the same id and the same locale, the source 
