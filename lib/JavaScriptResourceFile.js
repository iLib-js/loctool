...
JavaScriptResourceFile.prototype.getContent = function() {
    ...
    if (!this.defaultSpec) {
        this.defaultSpec = this.pathName ? this.locale.getSpec() : utils.getLocaleDefault(this.locale, this.flavor, this.project.settings.localeDefaults);
    }
    ...
    output += 'ilib.data.strings_' + this.defaultSpec.replace(/-/g, "_") + " = ";
...
JavaScriptResourceFile.prototype.getResourceFilePath = function(locale, flavor) {
    ...
    this.defaultSpec = utils.getLocaleDefault(locale, flavor, this.project.settings.localeDefaults);
    
    var filename = this.defaultSpec + ".js";
