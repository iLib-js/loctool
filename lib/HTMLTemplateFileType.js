...
var HTMLTemplateFileType = function(project) {
	...
	if (!project.settings.nopseudo) {
		// override the pseudo locale so we can treat the text as HTML instead
		this.pseudos[project.pseudoLocale] = new ResBundle({
	    	type: "html",
			locale: "zxx-XX",
			lengthen: "true"
		});
...
HTMLTemplateFileType.prototype.registerDataTypes = function() {
	ResourceFactory.registerDataType("html", "string", ResourceString);
};
