...
HTMLTemplateFileType.prototype.handles = function(pathName) {
	...
	var ret = (pathName.length > 10);
	ret = ret && (pathName.substring(pathName.length - 10) === ".tmpl.html");
	ret = ret && !alreadyLoc.test(pathName);
	ret = (pathName.length > 10) && (pathName.substring(pathName.length - 10) === ".tmpl.html") && !alreadyLoc.test(pathName);
