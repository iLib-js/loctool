 ...
 * @param {String} sourcehash the hash valye of the source
 ...
 */
ContextResourceString.hashKey = function(project, context, sourcehash, locale, reskey, datatype, flavor) {
    var key = ["crs", project, context, sourcehash, locale, reskey, datatype, flavor].join("_");
...
ContextResourceString.prototype.hashKey = function() {
    ...
    var sourceHash = utils.hashKey(this.source);
    return ContextResourceString.hashKey(this.project, this.context, sourceHash, locale, this.reskey, this.datatype, this.flavor);
};
 ...
 * @return {String} a hash key
 */
ContextResourceString.cleanHashKey = function(project, context, sourcehash, locale, reskey, datatype, flavor) {
    // reskey does not need cleaning for context strings
    return ContextResourceString.hashKey(project, context, sourcehash, locale, reskey, datatype, flavor);
};
...
ContextResourceString.prototype.cleanHashKey = function() {
    var locale = this.targetLocale || this.sourceLocale;
    var sourceHash = utils.hashKey(this.source);
    return ContextResourceString.cleanHashKey(this.project, this.context, sourceHash, locale, this.reskey, this.datatype, this.flavor);
};
