...
ContextResourceString.prototype.hashKey = function() {
    ...
    var key;
    if (this.source !== this.reskey) {
        key = this.source + this.reskey;
    } else {
        key = this.reskey;
    }
    return ContextResourceString.hashKey(this.project, this.context, locale, key, this.datatype, this.flavor);
};
...
ContextResourceString.prototype.cleanHashKey = function() {
    ...
    return ContextResourceString.cleanHashKey(this.project, this.context, locale, key, this.datatype, this.flavor);
};
