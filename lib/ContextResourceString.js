 ...
 */
ContextResourceString.hashKey = function(project, context, locale, reskey) {
...
ContextResourceString.prototype.hashKey = function() {
	return ContextResourceString.hashKey(this.project, this.context, this.locale, this.reskey);
};
...
ContextResourceString.prototype.hashKeyForTranslation = function(locale) {
	return ContextResourceString.hashKey(this.project, this.context, locale, this.reskey);
};
