...
ContextResourceString.prototype.hashKey = function() {
	return ContextResourceString.hashKey(this.project, this.context, this.locale, this.reskey, this.datatype, this.flavor);
};
...
/**
 * Return the name of the flavor for this resource.
 * 
 *  @return {String} the name of the flavor for this resource
 */
ContextResourceString.prototype.getFlavor = function() {
	return this.flavor || "main";
};
