...
/**
 * Return the resource key written in the target locale.
 *
 * @returns {String} the source string
 */
ResourceString.prototype.getReskey = function() {
    return this.reskey;
};

/**
 * Set the resource key string of this resource.
 *
 * @param {String} str the target string
 */
ResourceString.prototype.setReskey = function(str) {
    this.reskey = str;
};
