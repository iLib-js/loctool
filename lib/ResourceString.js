...
/**
 * Return true if the id of this resource was automatically generated,
 * and false if it was an explicit id. 
 * 
 * @returns {boolean} true if the id of this string was auto generated,
 * false otherwise
 */
ResourceString.prototype.getAutoId = function() {
	return this.autoId;
};
 ...
 * is no context.
 */
ResourceString.prototype.getContext = function() {
    return this.context;
};
...
ResourceString.prototype.merge = function(other) {
	...
	if (other.id !== this.id) {
		...
		if (other.locale === this.locale && other.source !== this.source) {
			throw "Duplicate resources: '" + this.id + ":" + this.source + "' and '" + other.id + ":" + other.source + "'";
		}
	}
	if (other) {
