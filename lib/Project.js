...
var GenerateResource = require("./GenerateResource.js");
 ...
 * generation is done
 */
Project.prototype.generateResource = function(cb) {
    logger.trace("Project generateResource");

    var genRes = new GenerateResource({
        targetDir: this.settings.targetDir,
        xliffsDir: this.settings.xliffsDir,
        resRoot: this.settings.xliffResRoot,
        resName: this.settings.xliffResName
    });
