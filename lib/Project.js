...
var Project = function(options, root, settings) {
    ...
    } else if (Array.isArray(this.pseudoLocales)) {
    ...
    if (this.settings.locales && this.pseudoLocales && !this.settings.nopseudo) {
        this.settings.locales = this.settings.locales.concat(Object.keys(this.pseudoLocales));
    }
