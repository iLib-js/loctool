...
ResourcePlural.prototype.generatePseudo = function(locale, pseudoBundle) {
	...
	for (var pluralClass in this.strings) {
		pseudoStrings[pluralClass] = utils.isAndroidResource(this.strings[pluralClass]) ? this.strings[pluralClass] : pseudoBundle.getStringForResource(this, pluralClass);
	}
...
ResourcePlural.prototype.cleanHashKey = function() {
	...
	return ResourcePlural.hashKey(this.project, this.context, this.locale, cleaned);
};
