...
IosStringsFile.prototype.extract = function() {
	...
	if (this.pathName) {
		...
		try {
			...
			if (this.project.options.resourceDirs["objc"] !== path.dirname(this.pathName) && dir === "en") {
...
IosStringsFile.prototype._parsePath = function() {
	if (!this._pathParsed) {
		...
		if (!this.locale) {
			...
			this.locale = (this.iosLocale === "en" ? this.project.sourceLocale: this.iosLocale) || this.project.sourceLocale;
		}
