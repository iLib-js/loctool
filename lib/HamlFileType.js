...
HamlFileType.prototype.processHamls = function(translations, locales) {
	...
	*/
	...
	for (var i = 0; i < this.files.length; i++) {
		...
		var args = [haml_localizer, locale, "/tmp/translations.yml", this.files[i]];
...
HamlFileType.prototype.registerDataTypes = function() {
	ResourceFactory.registerDataType("x-haml", "resource-string", ResourceString);
};
