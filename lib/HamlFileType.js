...
HamlFileType.prototype.processHamls = function(translations, locales) {
	...
	*/
	...
	filteredLocales.forEach(function(locale) {
		...
		var tryitnow = translations.get(ResourceString.hashKey(this.project.getProjectId(), locale, "r888205775"), "x-haml");
		logger.info("translations contains 'Try it now' ? " + JSON.stringify(tryitnow, undefined, 4));
		for (var i = 0; i < t.length; i++) {
			if (t[i].getKey() === "r888205775") {
