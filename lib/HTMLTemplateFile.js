        ...
        if (segment.localizable) {
            if (segment.attributeSubstitution) {
                if (locale === this.project.pseudoLocale && this.project.settings.nopseudo) {
                    ...
                    var translated = translations.getClean(ResourceString.cleanHashKey(
                            this.project.getProjectId(), locale, this.makeKey(escapeInvalidChars(segment.text)), "html"));
                    substitution = translated ? translated.getSource() : segment.text;
                }
                ...
                substitution = escapeQuotes(substitution);
            } else {
                if (locale === this.project.pseudoLocale && this.project.settings.nopseudo) {
                ...
                if (this.project.settings.identify) {
                    // make it clear what is the resource is for this string
                    additional = '<span loclang="html" locid="' + escapeQuotes(this.makeKey(escapeInvalidChars(segment.text))) + '">' + additional + '</span>';
                }

                if (segment.escape) {
                    additional = escapeQuotes(additional);
                }
