            ...
            if ((name === "title" || (localizableAttributes[lastTagName] && localizableAttributes[lastTagName][name])) &&
                ...
                if (this.tagtext) {
                    this.segments.enqueue({
                        ...
                        text: utils.escapeQuotes(source),
                        replacement: '{' + name + '}',
                        escape: true
                    });
                    ...
                    this.text = utils.escapeQuotes(source);
                    this._emitText(true);
                ...
                if (this.tagtext) {
                    this.tagtext += " " + name + '=' + utils.escapeQuotes(value);
                } else if (this.text) {
                    this.text += " " + name + '=' + utils.escapeQuotes(value);
                } else {
                    this.accumulator += " " + name + '=' + utils.escapeQuotes(value);
                }
            }
        }.bind(this),
