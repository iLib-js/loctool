 ...
 *
 * Copyright © 2016-2017, 2019-2020, 2024 HealthTap, Inc.
 *
...
/**
 * Convert each resource in the current resource set from a plural
 ...
 */
TranslationSet.prototype.convertToICU = function() {
    var resources = this.resources;
    this.clear();
    for (var i = 0; i < resources.length; i++) {
        var temp = conversions.convertPluralResToICU(resources[i]);
        this.add(temp || resources[i]);
    }
    return this;
};

/**
 * Convert each resource in the current resource set from an ICU-style
 ...
 */
TranslationSet.prototype.convertToPluralRes = function() {
    var resources = this.resources;
    this.clear();
    for (var i = 0; i < resources.length; i++) {
        var temp = conversions.convertICUToPluralRes(resources[i]);
        this.add(temp || resources[i]);
    }
    return this;
};
